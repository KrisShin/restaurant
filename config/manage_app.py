...
from apps.user.views_user_merchant import user as merchant_user
from apps.dish.views_dish_merchant import dish as merchant_dish
from .db_config import DBConfig
from .global_params import db, redis
from .settings import REDIS_URL, STATIC_FOLDER, STATIC_PATH


def create_app():
    '''Create an application of flask'''

    app = Flask(__name__, static_folder=STATIC_FOLDER, static_url_path=STATIC_PATH)
