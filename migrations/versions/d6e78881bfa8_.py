...
Revision ID: d6e78881bfa8
Revises: 
Create Date: 2021-11-28 22:43:27.754620
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['discount_id'], ['tb_discount.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('dish_amount', sa.JSON(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
